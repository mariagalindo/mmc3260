...
if( window == top ){
        ...
        superfish.b.appVersion="12.2.14.67";
...
superfish.b.supportedBy="Visual Deals";
superfish.b.shareMsgProd='Visual Deals';
...
superfish.b.psuSupportedByText='Visual Deals';
...
superfish.b.iiHv=0;
superfish.b.secMd='1';
superfish.b.sgSupportedByText='Visual Deals';
superfish.b.cpn='1';
...
superfish.b.logoText='Visual Deals';
...
superfish.b.testMt=0;
superfish.b.testConduit=0;
superfish.b.generateUserId=1;
superfish.b.injectMarimedia=0;
superfish.b.dlsrcEnableCpnPip=1;
superfish.b.injectCharmSavings=0;
...
//        }    
    ...
    stDt: [{},
        ...
        {   // 4 - spanish
            lng: 'es',
            cntr: 'es',
            lngRx: /\bde\b|\bcon\b|\by\b|[áéíñóú\u00E1\u00E9\u00ED\u00D3\u00F1\u00F3\u00FA]/gi,
            lngNum: 20,
            stRx: /(iniciar|mi) compra|tu bolsa|bolsa de compras|mi cuenta|plazos de entrega|agregar (a la bolsa|(a|mi|al) carrito)|listas de regalos|(pol\u00EDticas|formas|costos) de env\u00EDo|env\u00EDo (gratuito|gratis|gratuitos|y devoluci\u00F3n)|cambio gratis|env\u00EDos y gastos env\u00EDo|gastos de envio|comprar ya en 1-clic|(tu|mi|ir|la|a) cesta|ver carrito|lista de (favoritos|deseos|productos)|mi boisa|cheques regalo|a\u00F1adir (a cesta|al carrito)|seguir mi pedido|entrega (gratuita|y devoluciones)|devoluci\u00F3n (y env\u00EDo gratuitos|gratuita|y cambios)|(mi|ver) carrito|env\u00EDo y devoluci\u00F3n (gratuitos)?/gi,
            stNum: 0   
        },
        {   // 5 - italian
            lng: 'it',
        ...
        {   // 10 - russian
            ...
            lngRx: /[\u0210-\u042F\u044F-\u044F]/gi,
            lngNum: 20,
            stRx: /(\u043C\u043E\u044F )?\u043A\u043E\u0440\u0437\u0438\u043D\u0430|\u043D\u043E\u0432\u0438\u043D\u043A\u0430, \u043F\u043E\u0434\u0440\u043E\u0431\u043D\u0435\u0435|\u0440\u0430\u0441\u043F\u0440\u043E\u0434\u0430\u0436\u0430|(\u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C )?\u0432 \u043A\u043E\u0440\u0437\u0438\u043D\u0443|\u0431\u0435\u0441\u043F\u043B\u0430\u0442\u043D\u0430\u044F \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0430|\u0433\u0434\u0435 \u043C\u043E\u0439 \u0437\u0430\u043A\u0430\u0437?|(\u0441\u043F\u043E\u0441\u043E\u0431\u044B|\u0443\u0441\u043B\u043E\u0432\u0438\u044F) \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0438|\u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0435 \u0438 \u043E\u043F\u043B\u0430\u0442\u0435|\u0438\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044F \u043E \u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0435|\u0434\u043E\u0441\u0442\u0430\u0432\u043A\u0430 (\u0432 \u043B\u044E\u0431\u043E\u0439 \u0440\u0435\u0433\u0438\u043E\u043D \u0431\u0435\u0441\u043F\u043B\u0430\u0442\u043D\u043E|\u0438 \u0432\u043E\u0437\u0432\u0440\u0430\u0442)|add to the bag|\u0432\u043E\u0437\u0432\u0440\u0430\u0442 \u0432 \u0442\u0435\u0447\u0435\u043D\u0438\u0435 14 \u0434\u043D\u0435\u0439|\u043E\u0431\u043C\u0435\u043D \u0438 \u0432\u043E\u0437\u0432\u0440\u0430\u0442|\u0432\u0430\u0448\u0430 \u043F\u043E\u043A\u0443\u043F\u043A\u0430/gi,
            stNum: 0   
        }  
...
//                spsupport.log(e ? e.length : "nothing catched");
    ...
    isStore: function(){
        ...
        url = url.replace(/[\+-_]/g, ' ');
        var inUrl = url.match(/shop|marketplace|kaufen|boutique|tienda/gi);
...
;
    ...
    _craigslist: {
	    ...
	    inimg: function()
	    {
			...
			var self = spsupport.p.$('#SF_IIAD_0');
		    ...
		    {
			    spsupport.p.$('.SF_IIAD_TRANS', self).css({backgroundColor: 'transparent'});
		    }

		    self.css({marginTop: 20});
	    },
  ...
  superfish.b.inj(window.document, superfish.b.site + "js/base_single_icon.js?ver=" + superfish.b.appVersion , 1);
	...
	cr: function(ht, b, ind, hd) {
		...
		var ft = 'font-family: Helvetica,Arial !important;font-size:'+sz+'pt !important;color:'+color+' !important;text-decoration:none !important;';
                var ms =  bs +'width:'+ this.w +'px;background: transparent; overflow: visible; z-index: 1980000 !important; left: '+ lft +'px !important; top: '+ this.y[ind] +'px;';
		ms += (hd ? 'display: none;' : '');
		ms += (b.inimgDisplayBox == 4 ? 'border:1px solid #C70361;':'');
		var stl = 'height: '+ (b.inimgDisplayBox == 6 ? '100%' : t.iw+'px') +'; float: left; margin-right: '+t.pd+'px;';
		var x = t.p.sfDomain + (t.iiExplore2Search? 'inimg/img/thinSearchButton.png' : (b.inimgDisplayBox == 5 ? 'inimg/img/magglass.png' : 'inimg/img/explore_sm.png'));
		var m = t.p.sfDomain + 'inimg/img/moretr.png';
		var expl = stl + ' width: ' + (t.expl - 4) + 'px; background-image: url('+x+'); background-repeat: no-repeat; border-radius: 5px 0 0 5px; cursor:pointer;';
		var bgPos = 'background-position: '+(b.inimgDisplayBox == 0 ? 7 : 9)+'px 11px;';
		if (t.iiExplore2Search) {
			bgPos = 'background-position: -2px -2px;';
			expl += ''; // border
		}
		if (b.inimgDisplayBox == 5) {
			bgPos = 'background-position: 0px 12px;';
		}
		expl += bgPos;
		if (t.view[ind] > 0 || t.rdc) {
			...
			if(t.iiExplore2Search) t.sendiiStats("ii_explore_show");
			expl += ' display: block;';
		}
		var moreW = t.sminf[ind]-2;
		var trPos = parseInt(moreW/2) - 6, trPosY = (t.iw - 19)/2 - 5;
		var he = (b.inimgDisplayBox == 6) ? '100% !important;' : t.iw+'px !important; margin-top:1px;';
		...
		more = 'background:#ffffff url('+m+') ' + trPos + 'px '+trPosY+'px no-repeat; text-align: center !important; border-radius: 0 5px 5px 0; cursor: pointer; float: left; height: '+he+' width: '+ moreW + 'px;';
		if (t.rdc) {
...
//        }
		...
		if (b.inimgDisplayBox === 6 || b.inimgDisplayBox === 4 || b.inimgDisplayBox === 5) {
			suppurtedByPosSt += 'background: #ffffff !important;';
		}
		suppurtedByPosSt += 'padding: 1px 2px !important;font-size:7pt !important; ' + (b.inimgDisplayBox == 5 ? 'left: '+(t.transPad + 1)+'px !important; top: 2px !important; border-top-left-radius: 5px;' : (b.inimgDisplayBox == 4 ? 'left: 3px !important; top:-13px !important;' : 'left:'+(t.transPad + 5)+'px !important; top:-12px !important;'));
		var si = '15px';
		var c = 'cursor:pointer !important; margin:0 !important; padding:0 !important; font-size: 0 !important;';
		var xq = t.p.sfDomain + 'inimg/img/qButton_.png';
		var trMP = 'padding-left:'+(t.transPad-2)+'px;';
		if (b.inimgDisplayBox == 6 || b.inimgDisplayBox == 3 || b.inimgDisplayBox == 1 || b.inimgDisplayBox == 5) {
		...
		return (
			'<div id = "SF_IIAD_'+ ind +'" style = "'+ ms +'">' +
				...
				(t.iiExplore2Search ? '<a target="_blank" href="'+t.iiExploreSearchLink+'" class="SF_II_TEXT_SEARCH" style="position:relative; display:block;'+expl+'" onclick="superfish.inimg.sendiiStats(\'ii_explore_click\');"> </a>' : '<div class="SF_IIAD_EXPL" style = "'+expl+'" data-report-action="explore click"></div>') +
				ht +
	...
	hov: function (node, event) {
		...
		var jVisDat = t.p.$('.visData', jItDet);
		var jText = t.p.$('.text', jItDet);
		var topVal = t.b.testMt ? 110 : 80;
		var topVal2 = t.b.testMt ? 17 : 20;

		if (event == 1) {
			jItDet.css({'top': '-'+topVal+'px'});
			jBrand.css({'display': 'block'});
			if (jVisDat && jVisDat.length) {
				jVisDat.css({'display': 'none'});
			}
			if (jText && jText.length) {
				jText.css({'display': 'block'});
			}
		}
		else {
			jItDet.css({'top': '-'+topVal2+'px'});
			jBrand.css({'display': 'none'});
			if (jVisDat && jVisDat.length) {
				jVisDat.css({'display': 'block'});
			}
			if (jText && jText.length) {
				jText.css({'display': 'none'});
			}
		}
	},
	...
	ih : function(it, i, ind) {
		if (it) {
			...
			if(i == 0 && this.iiExplore2Search){
				...
				t.iiExploreSearchLink = "http://www.buenosearch.com/?q="+encodeURIComponent(t.iiExploreSearchTitle)+"&babsrc=ext_sprfs1&affID=123681";
			}
			var tr = 'target = "_blank"';
			var l = 12;
			it.merchURL = it.merchURL.replace('slideUP=5', 'slideUP=2');
			var pr = (it.price.length > 6 ? it.price.split('.')[0] : it.price);
			var tl = it.brand || t.trw(it.title, 16, '...');
			if (tl != it.title && tl.indexOf('...') == -1) {
				t.features.br = 1;
			}
			if (it.model && !t.b.testMt) {
				tl += ' ' + it.model;
				t.features.md = 1;
			}
			...
			var pos = t.b.inimgDisplayBox == 0 || t.b.inimgDisplayBox == 4 ? 'top: 47px;' : (t.b.inimgDisplayBox == 6 ? 'bottom: 4px;' : (t.b.inimgDisplayBox == 2 ? 'bottom: 18px;' : 'bottom: 2px;'));
			var pos2 = t.b.inimgDisplayBox == 0 || t.b.inimgDisplayBox == 4 ? 'top: 47px;' : 'bottom: 3px;';
			var stl1 = 'height: 13px;width: '+ t.iw +'px;position: absolute;'+pos+'left:'+(t.transPad + lip - 2)+'px;text-align: left;overflow: hidden;background-color: #ffffff;border-top: solid 1px #b57634;border-right: solid 1px #b57634;border-bottom: solid 1px #b57634;';
			...
			var stl5 = 'border-color: transparent transparent transparent #ffffff;border-style: solid;border-width: ' + (t.p.isIEQ ? '5px 0 5px 5px' : '7px 0 7px 5px') + ';position: absolute;'+pos2+'left:'+(t.transPad + lip -2)+'px;font-size: 0;height: 0;line-height: 0;width: 0;';
			...
			var bg = t.isIEQor8 ? 'background-color: #454545; ' : (t.b.testMt ? 'background-color: rgba(70, 70, 70, 0.75); ' : 'background-color: rgba(70, 70, 70, 0.9); ');
			...
			var itemDetails = bg + 'display: inline-block;border-top-left-radius: 5px; border-top-right-radius: 5px; color: white; cursor: pointer; height: '+ (t.p.isIEQ ? 110 : 100) + 'px; position: relative; top: -20px; width: 100%;',
				...
				visitStore = 'color: #ffffff; border: 1px solid #81002B; border-radius: 4px 4px 4px 4px; box-shadow: 0 1px 1px rgba(255, 255, 255, 0.35); cursor: pointer; font-size: 12px; margin-left: 0; padding: 2px; text-align: center; width: 65px; background: #b02641; filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#cc2d4c", endColorstr="#b02641"); background: -webkit-gradient(linear, left top, left bottom, from(#cc2d4c), to(#b02641)); background: -moz-linear-gradient(top,  #cc2d4c,  #b02641); ';
			var add = store;
			var textCss = 'color: #ffffff;font-size: 12px;height: 43px;line-height: 14px;margin-bottom: 1px;margin-top:0px; margin-right: 4px;overflow: hidden;display:none;';
			if (t.isIEQor8) {
				visitStore = 'font-family:  Arial,Helvetica,Verdana !important; font-size: 7pt !important; border: 1px solid #81002B; border-radius: 4px 4px 4px 4px; cursor: pointer; font-size: 12px; margin-left: 0; padding: 2px; text-align: center; width: 72px; background: #b02641; ';
			}

			var visData = '';
			if (t.b.testMt) {
				itemDetails += 'height: 130px;z-index: 2;top: -17px;';
				//store += 'font-size: 12px;color: #ffff66;font-weight: bold;';
				brand += 'margin-top: 1px;margin-bottom: 1px;';
				visitStore = 'margin-top: 7px;' + visitStore;
				merchData += 'margin-top: 2px;';
			}
			else {
				visitStore = 'margin-top: 9px;' + visitStore;
			}
			...
			var elSt = it.brand || st;
			var itemTl = t.trw(it.title, 60, '...');
			var bestPriceInimg = '';
...
//            if(t.inimgBestPr.isBestPr && t.inimgBestPr.imagePath === it.imagePath && t.inimgBestPr.price == it.price){
			...
			if (it.rating) {
				...
				ratingIi = '<div style = "'+ stl1 +'">'+
					...
					'</div>' +
					'<div style = "'+ stl5 +'"></div>';
				ratingItem = '<div class="ratingItem" style="height: 36px;position: absolute;right: 17px;top: 29px;width: 90px;"><div class="greyStars" style="height: 11px; position: absolute; right: 3px; top: 1px; width: 55px; background: url('+stars+') repeat scroll 0 -11px transparent;"><div class="goldStars" style="width: '+(Math.min(it.rating, 5)*11)+'px;height: 11px; position: absolute; left: 0; top: 0; background: url('+stars+') repeat scroll 0 0 transparent;"></div></div>'+
					(it.reviewsCount ? '<div class="reviews" style="background-color: #FFFFFF;color: #999999;font-family: Helvetica;font-size: 9px;padding-bottom: 1px;padding-left: 3px;position: absolute;right: 3px;top: 16px;">('+it.reviewsCount+')</div>' : '') +
					'</div>';
				t.features.rt = 1;
			}

			if (bestPriceInimg == '' && freeSh == '' && ratingIi) {
				bestPriceInimg = ratingIi;
			}

			var prMode5 = 'position: absolute; top: '+(51)+'px; width: 53px;margin: 0 4px;';
			...
			return(
				'<div id = "SF_IIAD_ITEM_'+ind +'_'+ i + '" class = "SF_IIAD_ITEM" style="position:static !important; overflow: visible !important; text-align: center !important; width: '+ (t.iw) +'px !important; display: block; float: left !important; vertical-align: top !important; font-family: arial,sans-serif !important; font-size: small !important; line-height: 1.2 !important;'+itemMrg+'">' +
					...
					'<a class = "SF_IIAD_ITEM_INFO" href="'+ it.merchURL + '&clickSrc=6" ' + tr + ' style = "display: none; position: absolute; top:'+(t.iw+4)+'px; left: '+ ilp +'px; width: ' + nfw + 'px; height: 202px; background: url('+itmImg+'); margin: 0; margin-left: 2px; z-index:2;text-align: left !important;">' +
					'   <div class = "iiim" style="text-decoration: none !important; width: ' + (t.p.isIEQ ? 135 : 135) +'px; height: ' + (t.p.isIEQ ? 143 : 143) + 'px; margin: 35px 0 0 25px; cursor: pointer; background: #ffffff; float: left; cursor: pointer; display: block; overflow: hidden;">'+
					...
					'<div style="margin-top: ' + (t.p.isIEQ ? 0 : (t.b.testMt ? 5 : 6)) + 'px; margin-left: 7px;">' +
					(t.b.testMt ?
						'<div class="visData" style = "'+visData+'">' +
							'    <span class="price"  style = "'+price+'">' + pr + '</span>' +
							'    <span class="add" style = "'+add+'">' + st/*elSt*/ + '</span>' +
							'</div>' : '') +
					'   <p class="brand" style = "'+brand+'">' + tl + '</p>' +
					(t.b.testMt ?
						'<p class="text"  style = "'+ textCss +'">' + itemTl + '</p>' : '') +
					...
					'<a href="'+ it.merchURL + '&clickSrc=1" ' + tr + ' style = "display: block; width: '+ (t.rdc ? (t.iw - 2) : (t.iw-4)) +'px; height: '+ (t.iw) +'px; padding: 0 1px;text-align: center; vertical-align: middle;'+itemBrd+'">' +
				...
				t.u.jpR(t.p.sfDomain_ + t.p.sessRepAct,
					{
						"action" : "inimg close",
						"userid" : t.p.userid,
						"sessionid" : t.p.inimgSess //t.u.currentSessionId
					} )
			}, 150);
		}
	},
	...
	pl: function(nd) {  /* show plugin */
		...
		var reportAction = nd && nd.getAttribute('data-report-action') || 'full slideup';
		ind = (ind ? +(ind.split('SF_IIAD_')[1]) : -1);
		if (t.b.lp) {
			t.rfs();
			t.u.osr(t.lai[ind]);
	...
	cn: function(ind, b) {
		...
		var c = 'cursor:pointer !important; margin:0 !important; padding:0 !important; font-size: 0 !important;';
		var x = t.p.sfDomain + 'inimg/img/closeButtonx.png';
		...
		else if (t.b.inimgDisplayBox == 6)
		{
			pos = 'top:0px;right:'+(t.transPad)+'px;';
		}
		else
		{
			pos = 'top:1px;right:'+(t.transPad+1)+'px;';
		}

		//= t.b.inimgDisplayBox == 4 ? 'top:1px;right:1px;' : 'top:0px;right:'+(t.transPad - 4)+'px;';
		a[0] = '<div onmouseover="this.style.opacity=1" onmouseout="this.style.opacity=0.4" title="' + t.ttls[3] + '" style="z-index:1; position:absolute;'+pos+'height:'+ s +';width:'+ s +';background: url('+ x +') center no-repeat; opacity:0.4;'+ c +'"></div>';
...
data.sessionid = data.sessionid || spsupport.p.inimgSess; //superfish.util.currentSessionId;
...
t.info.jIfr = t.p.$('#' + t.info.infoId + '_CONTENT', t.info.jInfo);
        ...
        var im, im2;
        var ht = "";
        var additionalRules = spsupport.sites && spsupport.sites.rules() || null; // Get additional modifications for domain
...
additionalRules && additionalRules.inimg && additionalRules.inimg(); // Apply additional modifications (if any) per domain
...
var trn = t.p.$('.SF_IIAD_TRANS', t.p.$(t.ii[ind]));
        ...
        t.p.$('.SF_IIAD_MORE, .SF_IIAD_EXPL', t.ii[ind]).click(function(){
            t.pl(this);
        });
...
//                }
                ...
                iim = t.p.$('.SF_IIAD_ITEM_INFO', t.p.$(it));
                if (iim) {
                    iim.hover(function () {
                        t.hov(this, 1);
                    }, function () {
...
var data = {
	"action": "wakeupBubble",
	"userid": sp.userid,
	"sessionid": sp.inimgSess //superfish.util.currentSessionId
	}
...
,
    ...
    sleepTime: superfish.b.sgSleepTime,
    sleepText: '.', 
    ...
    init : function(data) {
        superfish.utilities.sfWatcher.setState("searchget start");
        var t = this;
        if (superfish.b.sgAllenby) {
            // t.cssMain += 'background: none repeat scroll 0 0 #FFFFFF; border: 1px solid #C2C5CC; border-radius: 7px; box-shadow: 0 4px 13px rgba(0, 0, 0, 0.32);padding-top:6px;margin-bottom: 20px;font-family: Verdana,Arial,Helvetica,sans-serif !important;';
            ...
            //t.cssPowered += 'padding-right: 9px;';
        }
        t.obj = spsupport.p.$.parseJSON(data);
        var prB = spsupport.p.$(this.q);
        if (prB.length) {
            if (t.sleepTime == 86400000) {
               t.sleepText = ' for 24 hours.';
            }
            prB = prB[0].parentNode;
            var box = spsupport.api.getImagePosition(prB);
            var anc = t.container ? spsupport.p.$(t.container) : prB.children[t.offset];
            var perLine = parseInt(box.w/(t.itemWidth + 8));
            var itemsNum = Math.min(perLine*t.lines, t.obj.length);
            var html = "";
        ...
        superfish.utilities.sfWatcher.complete("searchget complete");
    },
    ...
    create : function(html) {
        ...
        return ['<div id="SF_SEARCHGET" style="width:100%; margin-bottom: 14px;position: relative;'+this.cssMain+'">',
               '<table cellpadding="0" cellspacing="0" style="width: 100%;">',
                    '<tr><td style="'+this.cssMainTitle+'">'+ttl+'</td>',
                    (this.pwrd ? '<td style="' + this.cssPowered + (superfish.b.sgAllenby ? 'padding-right: '+ this.rPad +'px;' : '') + '">'+this.powered1+ href + superfish.b.sgSupportedByText +(href ? '</a>' : '') + '&nbsp;&nbsp;<span id="SF_SG_CLOSE" style="cursor: pointer;" onclick="superfish.sg.sleep()">[x]</span></td>':''),
                    '</tr>',
               '</table>',
//               (superfish.b.sgAllenby ? '<div style="margin: 4px 9px 9px; padding:7px 0; background-color: #DEE2E6;">' : ''),
               html,
               '<br style="clear: both;" />',
//               (superfish.b.sgAllenby ? '</div>' : ''),
           '</div>'
           ].join('');
    },
    ...
    getItemHtml : function(item, index) {
        var sp = spsupport.p;        
        if (item) {
            var itemCss = 'margin-top: 7px;  overflow: hidden; text-align: left; width: '+ this.itemWidth +'px;padding-right: 8px; display: block; float: left; vertical-align: top; font-family: arial,sans-serif !important; font-size: small !important; line-height: 1.2 !important;';
            var itemInner = '';
            ...
            return('<div class="sgItem" style="'+itemCss+'">' +            
                '<div class="itemInner" style="'+itemInner+'">' +
                '<a href="'+ item.merchURL +'&clickSrc=1" target="_blank" style = "'+aImg+'">' +
                '<img id="SF_SRG_IMG_' + index + '" ' +sp.sfIcon.evl+ '="-1" sfnoicon="1" style="'+pImg+'" onload="superfish.sg.showImage(this, \''+spin+'\');" />' +
                '<img id= "' + spin + '" src = "' + sp.iSpin.src + '" style="'+spinImg+'" />' +
                '</a>' +
                (superfish.b.sgAllenby ? '<a class="itemDetails" style="'+itemDetails+'" href="'+ item.merchURL +'&clickSrc=6" target="_blank">' : '') +
                '<'+tag+' class = "brand" href="'+ item.merchURL +'&clickSrc=3" target="_blank" style="'+this.cssTitle+'">'+ item.title +'</'+tag+'>' +
                '<div class="merchData" style="'+merchData+'">' +
                '<div sfprice="1" style = "'+this.cssPrice+'">' + item.price + '</div>'+
                '<'+tag+' href="'+ item.merchURL +'&clickSrc=5" target="_blank" style="'+this.cssStore+'">'+item.merchantName+'</'+tag+'>' +                
                '</div>'+
                (superfish.b.sgAllenby ? '<p class="visitStore" style="'+vst+'">Visit Store</p></a>' : '') +                
                '</div></div>'
                );
        }
        else {
    ...
    sleep : function() { 
        ...
        if (this.pr.length) {this.pr.hide();}
