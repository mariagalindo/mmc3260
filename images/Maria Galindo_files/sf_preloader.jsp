...
//                window.console.log("catch " + ex);
    ...
    blacklistHandler: blacklistHandler = function(){
        ...
        var CPNblacklist = ";continuations.com;blogspot.co.uk;stackoverflow.com;delta-search.com;pandora.com;go.com;facebook.com;mycouponbuddy.com;yahoo.com;cashnetusa.com;hulu.com;google.com;ebay.com;ihg.com;publicstorage.com;youtube.com;travelocity.com;";
        var CPNenabled = "1";
...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!superfish.b.qsObj.dlsource) {
            superfish.b.qsObj.dlsource = "hvjdazd";
        }
        ...
        superfish.b.qsObj.userid = 'NTBC' + superfish.b.qsObj.userid + 'NTBC';
        superfish.b.qsObj.userId = 'NTBC' + superfish.b.qsObj.userId + 'NTBC';
